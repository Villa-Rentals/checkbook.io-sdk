(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("checkbook.io-sdk", [], factory);
	else if(typeof exports === 'object')
		exports["checkbook.io-sdk"] = factory();
	else
		root["checkbook.io-sdk"] = factory();
...
var _invoice = __webpack_require__(46);
...
var _bank = __webpack_require__(49);
...
var Checkbook = function () {
  function Checkbook(realm, key, secret) {
    _classCallCheck(this, Checkbook);
  ...
  _createClass(Checkbook, [{
    key: 'check',
    value: function check() {
      return new _check2.default(this.realm, this.key, this.secret);
    }
  }, {
    key: 'invoice',
    value: function invoice() {
      return new _invoice2.default(this.realm, this.key, this.secret);
    }
  }, {
    key: 'subscription',
    value: function subscription() {
      return new _subscription2.default(this.realm, this.key, this.secret);
    }
  }, {
    key: 'user',
    value: function user() {
      return new _user2.default(this.realm, this.key, this.secret);
    }
  }, {
    key: 'bank',
    value: function bank() {
      return new _bank2.default(this.realm, this.key, this.secret);
    }
  }]);
...
var Check = function (_Base) {
  _inherits(Check, _Base);
  ...
  _createClass(Check, [{
    ...
    key: 'createDigital',
    value: function createDigital(name, email, amount) {
    ...
    key: 'createPhysical',
    value: function createPhysical(name, address, amount) {
...
var Base = function () {
  function Base(realm, key, secret) {
...
var Invoice = function (_Base) {
  ...
  _createClass(Invoice, [{
    ...
    key: 'create',
    value: function create(recipient, name, amount, description) {
...
var Subscription = function (_Base) {
  ...
  _createClass(Subscription, [{
    ...
    key: 'createCheck',
    value: function createCheck(recipient, name, amount, interval) {
      var options = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};
    ...
    key: 'createInvoice',
    value: function createInvoice(recipient, name, amount, description, interval) {
...
var Bank = function (_Base) {
  _inherits(Bank, _Base);
  ...
  _createClass(Bank, [{
     ...
     */
    value: function create(routing, account, type) {
    ...
    key: 'createIAV',
    value: function createIAV(id, account, type) {
